...
const displayQuestions = () => {
    ...
    for (let i = 0; i < numberOfQuestions; i++) {
        ...
        <div>
        <input class="q_id" type="text" placeholder="Enter question id">
    ...
    const displayedQuestions = document.querySelectorAll('.q_id')
...
document.getElementById('numberOfQuestions').addEventListener("keypress", (event) => {
    if(event.key == "Enter"){
        displayQuestions()
    }
})
